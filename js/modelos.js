    ...
    element.addEventListener("click",()=>{
        ...
        switch (clase){
            case "color-1":
                ...
                infoColor.innerHTML=`Color Selecionado: <br> <span>BLANCO</span>`;
                break;
            case "color-2":
                imgColor.src="../img/modelos/colores/etios/Etios-Blanco-Perlado-1024x768.webp";
                infoColor.innerHTML=`Color Selecionado: <br> <span>BLANCO PERLADO</span>`;
                break;
            case "color-3":
                imgColor.src="../img/modelos/colores/etios/Etios-Gris-Plata-1024x768.webp"
                infoColor.innerHTML=`Color Selecionado: <br> <span>GRIS PLATA</span>`;
                break;
            case "color-4":
                imgColor.src="../img/modelos/colores/etios/Etios-Gris-Oscuro-1024x768.webp"
                infoColor.innerHTML=`Color Selecionado: <br> <span>GRIS OSCURO</span>`;
                break
            case "color-5":
                imgColor.src="../img/modelos/colores/etios/Etios-Negro-1024x768.webp"
                infoColor.innerHTML=`Color Selecionado: <br><span>NEGRO</span>`;
                break
            case "color-6":
                imgColor.src="../img/modelos/colores/etios/Etios-Rojo-1024x768.webp"
                infoColor.innerHTML=`Color Selecionado: <br> <span>ROJO</span>`;
                break
        }
...
const enviarContacto= document.getElementById("modelos-contactar");
