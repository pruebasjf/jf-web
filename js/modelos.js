...
colorSelector.forEach(element=>{
    ...
    //************************  HILUX  *****************************************
     ...
     //************************  LAND CRUISER 3000  *****************************************
            case "color-63": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-super-planco.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>SUPER BLANCO</span>`;
                break;
            case "color-64": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-blanco-perlado.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>BLANCO PERLADO</span>`;
                break;
            case "color-65": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-bronce-metalizado.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>BRONCE METALIZADO</span>`;
                break;
            case "color-66": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-gris-plata.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>GRIS PLATA</span>`;
                break;
            case "color-67": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-negro.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>NEGRO</span>`;
                break;
            case "color-68": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-rojo.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>ROJO</span>`;
                break;
            case "color-69": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-negro-mica.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>NEGRO MICA</span>`;
                break;
            case "color-70": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-gris-oscuro.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>GRIS OSCURO</span>`;
                break;
            case "color-71": 
                imgColor.src="../img/modelos/colores/land-cruiser-300/lc300-azul-metalizado.webp"
                infoColor.innerHTML=`Color Seleccionado: <br><span>AZUL METALIZADO</span>`;
                break;
        }
    })
